<template>
  <v-card tile color="lightGrey" elevation="10">
    <v-navigation-drawer permanent id="sideMenu" height="calc(100vh - 94px)" color="transparent" width="100%">
      <v-container class="ma-4">
        ...
        <v-list nav>
          ...
          <v-list-item link to="PropertyListing">
            <v-list-item-content>
              <v-list-item-title>Post New Listing</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link>
            <v-list-item-content>
              <v-list-item-title>Marketing Services</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list>
